...
Robot.prototype = Object.assign(Object.create(THREE.Object3D.prototype), {
	...
	angleAndSpeed: function(hitDist, targetDist) {
		...
		for(i = 0; i < ft.length; i++){
			if(ft[i][0] >= hitDist && i === 0){
				...
				for( ; j1 < minJ && j2 < maxJ; j1++, j2++){
					...
					for(k2 = 1; k2 < ft[i][j2].length; k2++){
						if(ft[i][j2][k2][0] >= targetDist && k2 === 1){
							if(data1 === undefined) oldData = [ft[i][j2][k2][1], ft[i][j2][0]];
							else {
								return [this.calculate(
									ft[i-1][0], ft[i][0],
				...
				return [ft[i][maxJ-1][ft[i][maxJ-1].length-1][1], ft[i][maxJ-1][0]];
			}
	...
	forceTable: [
		...
		[
			...
			[
				1.3,
				[45.31, 20], [95.07, 30], [133.89, 40],
			],
			[
				1.2,
				[79.3, 20], [144.44, 30], [194.13, 40],
			],
			[
				1.1,
				[108.26, 20], [185.34, 30], [245.82, 40],
			],
			[
				1,
				[216.99, 30], [287.38, 40], [341.44, 50],
			],
			[
				0.9,
				[318.21, 40], [379.59, 50], [428.26, 60],
			],
		],
		///////////////////////////////////////////////////
		[
			...
			[
				0.7,
				[251.39, 40], [322.86, 50], [379.58, 60], [429.38, 70], [471.02, 80],
			],
			[
				0.6,
			...
			[
				0.5,
				[389.42, 60], [443.85, 70], [489.17, 80], [529.997, 90],
			],
		],
		///////////////////////////////////////////////////
		[
			...
			[
				1,
				[85.77, 40], [141.44, 50], [184.18, 60], [221.0, 70],
			],
			[
				0.9,
			...
			[
				0.8,
				[140.35, 40], [208.4, 50], [260.23, 60], [305.40, 70],
			],
			[
				0.7,
			...
			[
				...
				[430.0 ,  90], [463.83, 100], [494.64, 110], [522.84, 120],
		...
		[
			...
			[
				1,
				[84.19, 60], [121.00, 70], [151.71, 80],
			],
			[
				0.9,
				[79.59, 50], [128.26, 60], [168.62, 70],
			],
			[
				0.8,
				[108.4, 50], [160.23, 60], [205.40, 70], [243.14, 80],
			],
			[
				0.7,
		...
		[
			...
			[
				...
				[393.68, 230], [400.22, 240], [407.46, 250], [414.23, 260],
				[419.43, 270], [425.36, 280], [430.91, 290], [435.01, 300],
				[439.86, 310], [443.33, 320], [446.50, 330], [450.44, 340],
				[453.06, 350], [455.42, 360],
			],
			[
				0.7,
				...
				[491.71, 300], [495.85, 310], [501.03, 320], [504.51, 330],
				[507.68, 340], [511.90, 350], [514.50, 360], [516.82 ,370],
				[518.87, 380], [521.98, 390],
			],
			[
				0.6,
